...
def extensions(
    ...
    - Branch composite (prefer): build_branch (spec_json, including
      conditional_edges), patch_branch (changes_json, including
      add_conditional_edge / remove_conditional_edge).
