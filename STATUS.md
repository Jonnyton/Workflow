...
| PROBE-002 live-status stamp — Task Scheduler entry absent; catalog/audit should say host activation still pending. | STATUS.md, docs/ops/acceptance-probe-catalog.md, docs/audits/2026-04-27-probe-catalog-state.md | read-only host check | claimed:codex-gpt5-desktop |
