...
| Scorched Tanks PWA clean-use watch — live page + MCP run green 2026-04-30; no independent real-user use visible yet. | WebSite/site/static/play/scorched-tanks, live MCP branch 5ef9185bed3f | - | monitoring |
