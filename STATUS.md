...
| Provider identity bridge - fold client-surface identity rule into user rollout; branch `codex/provider-identity-bridge`, worktree `../wf-provider-identity-bridge`, ready PR expected; refs: PLAN user capability/auth/control, MCP host matrix, hostless BYOK. | PLAN.md, docs/design-notes/2026-05-01-mcp-host-customer-matrix.md, docs/design-notes/2026-05-02-provider-identity-bridge.md | host-approved 2026-05-02; no runtime implementation | claimed:codex-gpt5-desktop-identity-rollout ACTIVE 2026-05-02 |
