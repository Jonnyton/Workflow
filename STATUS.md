...
| Site DNS cutover canary gate - apply workflow must fail if canonical MCP canary is red. | STATUS.md, .github/workflows/site-dns-cutover.yml | clear | claimed:codex-gpt5-desktop |
