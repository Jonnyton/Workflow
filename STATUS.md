...
| Agent-teams burn-down row retirement — checklist already exists; leave blocked idea in Active Promotions only. | ideas/PIPELINE.md | - | claimed:codex-gpt5-desktop |
