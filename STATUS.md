...
| Community change loop — #90 red only at writer queue; intake/uptime/deploy green. Needs `CLAUDE_CODE_OAUTH_TOKEN` or `WORKFLOW_CODEX_AUTH_JSON_B64`; live `llm_endpoint_bound=unset`. | GitHub Actions secrets; /etc/workflow/env | - | host-action |
