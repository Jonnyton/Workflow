...
| CF Access verify-exit fix - cutover/rollback post-apply probes must fail the script on bad verification. | STATUS.md, scripts/cf_access_cutover.py, scripts/cf_access_rollback.py | clear | claimed:codex-gpt5-desktop |
