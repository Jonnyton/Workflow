...
| Desktop reload rename cleanup - classify `fantasy_daemon/desktop/*` as UI changes, not full code reload. | workflow/desktop/launcher.py, tests/test_desktop.py | - | claimed:codex-gpt5-desktop ACTIVE 2026-05-02 |
