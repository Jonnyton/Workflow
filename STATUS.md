...
| Goals search normalization - improve BUG-033/F12 discovery recall for punctuation/hyphen variants without changing OR-ranked response shape. | workflow/daemon_server.py, tests/test_goals_search_multi_token.py, packaging/claude-plugin/plugins/workflow-universe-server/runtime/workflow/daemon_server.py | BUG-033 shipped; F12 weak discovery | claimed:codex-gpt5-desktop |
