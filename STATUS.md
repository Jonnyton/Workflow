...
| Community change loop — Codex subscription produced PR #96; patching PR-policy fallback + worker staleness proof. | Dockerfile, .github/workflows/auto-fix-bug.yml, .github/workflows/deploy-prod.yml, scripts/{community_loop_watch,verify_llm_binding}.py, tests/test_{auto_fix_workflow,deploy_prod_workflow,verify_llm_binding}.py, docs/ops/auto-fix-runbook.md, STATUS.md | - | claimed:codex-gpt5-desktop |
