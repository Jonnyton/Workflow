...
| MCP tool canary directory mode - make `mcp_tool_canary.py` verify `/mcp-directory` without legacy `universe`. | scripts/mcp_tool_canary.py, tests/test_mcp_tool_canary.py, docs/ops/acceptance-probe-catalog.md | observed directory canary false-red 2026-05-02 | claimed:codex-gpt5-desktop |
