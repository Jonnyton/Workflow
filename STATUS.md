...
| Community change loop — #90 red; current slice wires deploy-prod subscription-bundle sync + LLM-binding verify. GHA Claude OAuth false; Codex bundle visibility unknown until deploy run. | .github/workflows/deploy-prod.yml, deploy/docker-entrypoint.sh, docs/ops/host-independence-runbook.md, tests/{test_auto_fix_workflow,test_deploy_prod_workflow,test_dockerfile_shape}.py | #18 broad tests lock accepted for uptime unblock | claimed:codex-gpt5-desktop ACTIVE 2026-04-30 |
