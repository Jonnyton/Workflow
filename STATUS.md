...
| MCP probe raw flag ergonomics - allow `--raw` after status/universes/universe/wiki subcommands as documented. | STATUS.md, scripts/mcp_probe.py | clear | claimed:codex-gpt5-desktop |
