...
| LLM binding verifier honesty - remove stale standalone `add_canon` exercise warning from binding canary. | STATUS.md, scripts/verify_llm_binding.py | clear | claimed:codex-gpt5-desktop |
