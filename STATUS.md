...
| Directory submissions + first-use evidence - Claude form p2 + OpenAI login reached; Codex CLI read-call proof in progress. | chatgpt-app-submission.json, docs/ops/mcp-*.md, docs/design-notes/2026-05-01-mcp-host-customer-matrix.md, WebSite/site/src/routes/connect/+page.svelte, WebSite/site/static/llms.txt | contact/final-submit approval + OpenAI login | claimed:codex-gpt5-desktop |
