...
| Selfhost smoke Access-gate correction - default should expect direct tunnel 401/403, not public MCP parity. | STATUS.md, scripts/selfhost_smoke.py, docs/ops/acceptance-probe-catalog.md, docs/exec-plans/active/2026-04-20-selfhost-uptime-migration.md | clear | claimed:codex-gpt5-desktop |
