...
|------|-------|---------|--------|
| Auto-ship #3 loop-created PR action — feature-flagged PR creation from existing `auto-change/*` branch; no auto-merge. | `workflow/auto_ship_pr.py`, `workflow/api/auto_ship_actions.py`, `workflow/api/extensions.py`, `workflow/universe_server.py`, `tests/test_auto_ship_pr.py`, `tests/test_validate_ship_packet_action.py`, plugin mirror for touched workflow files | PR #243, activity.log 2026-05-03T23:25Z | claimed:codex-gpt5-desktop |
