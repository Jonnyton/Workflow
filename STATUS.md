...
|------|-------|---------|--------|
| Exec-plan index cleanup — move landed Arc B index entry from active to completed. | STATUS.md, docs/exec-plans/INDEX.md | Arc B landed | claimed:codex-gpt5-desktop |
