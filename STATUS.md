...
| OpenAI/Claude directory submission host actions - repo closeout landed/deployed in PR #197; OpenAI domain challenge in progress; needs ChatGPT mobile proof, publisher/legal assertions, final submit; Claude UI proof/form submit. | WebSite/site/static/.well-known/openai-apps-challenge; OpenAI Apps dashboard; ChatGPT mobile app; Claude.ai/Claude directory form | action-time Verify Domain/final-submit approval | host-action |
