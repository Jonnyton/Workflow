...
| MCP probe protocol drift - align operator probe initialize payload with canonical public canary. | STATUS.md, scripts/mcp_probe.py | clear | claimed:codex-gpt5-desktop |
