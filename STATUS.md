...
| Git hook installer worktree support — install hooks via git-reported hooks path, not checkout `.git/hooks`. | STATUS.md, scripts/install-git-hooks.ps1 | clear | claimed:codex-gpt5-desktop |
