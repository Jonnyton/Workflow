...
| Community change loop — Codex subscription visible in GHA/prod; live `llm_endpoint_bound=codex`; verifier schema fix in flight, then watch auto-fix queue. | scripts/verify_llm_binding.py, tests/test_verify_llm_binding.py, STATUS.md | - | claimed:codex-gpt5-desktop |
