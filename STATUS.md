...
| BUG-047 loop circuit investigation trigger smoke — fix ready; opposite-family checker required before landing. | workflow/api/helpers.py, tests/test_bug_investigation_wiring.py, packaging/claude-plugin/plugins/workflow-universe-server/runtime/workflow/api/helpers.py | - | host-review |
