...
| External directory acceptance — Open WebUI + LibreChat proofs green; roll out MCP Registry/Claude/ChatGPT submissions, next local/IDE proof, first-user evidence. ACTIVE 2026-05-01 | packaging/registry/server.json, chatgpt-app-submission.json, docs/ops/mcp-*.md, docs/ops/open-webui-*.md, docs/ops/librechat-*.md, docs/design-notes/2026-05-01-mcp-host-customer-matrix.md, docs/exec-plans/active/2026-05-01-host-discoverability-and-onboarding-rollout.md | host/admin publisher approval from chat 2026-05-01 | claimed:codex-gpt5-desktop |
