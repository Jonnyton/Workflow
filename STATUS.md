...
| BUG-034 ChatGPT legacy Goals action alias - branch `codex/chatgpt-goals-action-alias`, worktree `../wf-chatgpt-goals-action-alias`, PR expected; accept provider-routed directory action names in legacy Goals wrapper without changing `/mcp-directory` metadata. | `_PURPOSE.md`, `workflow/api/market.py`, `packaging/claude-plugin/plugins/workflow-universe-server/runtime/workflow/api/market.py`, `tests/test_api_market.py` | BUG-034 evidence in `docs/ops/openai-app-submission-prep-2026-05-02.md`; avoid `.agents/worktrees.md` owned by worktree-discipline lane | claimed:codex-gpt5-desktop-accessibility ACTIVE 2026-05-02 |
| Community loop canonical invoke smoke - parent `4da58d59ff4c4e18`/child `c788bb7380484196` hit Codex/bwrap; PR #157 CI-green draft fixes provider fail-loud/runtime+bwrap status; rerun after Claude review+merge. | workflow/providers/{base,codex_provider}.py, workflow/sandbox/detect.py, workflow/runs.py, workflow/graph_compiler.py, workflow/api/runs.py, tests/test_{providers,sandbox_unavailable,sandbox_detect,graph_compiler_empty_response,node_timeout,sub_branch_invocation,wait_for_run}.py, docs/exec-plans/active/2026-04-30-live-community-reiteration-loop.md, MCP live branches fd5c66b1d87d/e019229850f9 | Claude review of #157 | claimed:codex-loop-uptime-chatgpt |
