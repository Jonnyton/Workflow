...
- [filed:2026-04-30 verified:2026-05-02] Scorched exact: AROS fails v1.77/1.85/1.90 (`0x0100000F`/black); licensed Kickstart path still needed.
...
|------|-------|---------|--------|
| Scorched AROS exact-original proof — ACTIVE 2026-05-02; branch `codex/scorched-tanks-browser-pwa-live-main`; worktree `../Workflow-scorched-pwa-live` (legacy pre-`wf-` name); draft PR expected; acceptance requires input, sound, tank hit, visible state change, opposite-provider review. AROS+AMOS still fail; hosted/user Kickstart route now browser-harness verified; next: licensed Kickstart/Amiga Forever entitlement proof or deeper AMOS/AROS patch. | WebSite/site/static/play/scorched-tanks/, output/{online-research,sae-smoke,ejs-puae-smoke.mjs}, WebSite/site/output/{sae-smoke,ejs-puae}/, .agents/skills/{classic-game-design-test,using-agent-skills,game-prototyping}/, .claude/skills/{classic-game-design-test,using-agent-skills,game-prototyping}/, docs/design-notes/2026-04-30-exact-classic-game-browser-runtime.md, docs/design-notes/2026-05-01-classic-game-endpoint-delivery.md, _PURPOSE.md, .agents/worktrees.md, STATUS.md | refs: runtime design note; memories: none found; related: host/licensed Kickstart/Amiga Forever lane | claimed:codex-gpt5-desktop |
...
| Community change loop + developer soul default — developer daemon live; chatbot-first host control design live @01d9b98; deploy/canary green 2026-05-01Z; ChatGPT user-sim found missing PR/issue/PLAN review context; loop watch red on #39 queue. | PLAN.md, Dockerfile, .dockerignore, .github/workflows/{auto-fix-bug,community-loop-watch,deploy-prod,uptime-canary}.yml, scripts/{community_loop_watch,verify_llm_binding}.py, workflow_tray.py, workflow/{work_targets.py,api/{universe,prompts}.py,universe_server.py,daemon_registry.py}, packaging/claude-plugin/plugins/workflow-universe-server/runtime/workflow/{work_targets.py,api/{universe,prompts}.py,universe_server.py,daemon_registry.py}, fantasy_daemon/{__main__,branch_registrations}.py, tests/test_{api_universe,mcp_dispatch_docstring_parity,dockerfile_shape,goals_discoverability,universe_server_metadata,auto_fix_workflow,deploy_prod_workflow,verify_llm_binding,dns_canary_workflow,daemon_registry,fantasy_daemon_loop_identity}.py, docs/ops/auto-fix-runbook.md, docs/souls/workflow-developer-daemon.md, .agents/skills/ui-test/SKILL.md, .claude/skills/ui-test/SKILL.md, output/user_sim_session.md, STATUS.md | wait clean loop signal/user evidence; implement ownership-scoped control API; #18 broad lock overlaps docstring/tests by host direction | claimed:codex-gpt5-desktop |
