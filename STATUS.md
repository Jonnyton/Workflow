...
|------|-------|---------|--------|
| PR #828 skill-sync refactor — replace rejected design-note route with project-design brain-page/skill-loading loop guardrails. | `.github/workflows/auto-fix-bug.yml`, `scripts/provider_context_feed.py`, `tests/test_auto_fix_workflow.py`, `tests/test_provider_context_feed.py`, `pages/concepts/skill-sync-via-brain-pages.md`, `.agents/worktrees.md` | issue #826; closed PR #828; Cowork reject note | claimed:codex ACTIVE 2026-05-12 |
