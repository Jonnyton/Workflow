...
- **[P0 filed:2026-05-01 verified:2026-05-01]** Public MCP `tinyassets.io/mcp` flapping 502 during prod deploy; Worker/tunnel origin 530.
...
|------|-------|---------|--------|
| Public MCP P0 recovery — `tinyassets.io/mcp` flaps 502 during prod deploy; verify stable green or fix tunnel deploy path. | STATUS.md, deploy/, .github/workflows/, tests/test_build_image_workflow.py | production deploy/tunnel | claimed:codex-gpt5-desktop |
