...
| OpenAI/Claude directory submission host actions - repo closeout ready after this branch lands; needs live site deploy, ChatGPT mobile proof, publisher/legal assertions, final submit; Claude UI proof/form submit. | OpenAI Apps dashboard; ChatGPT mobile app; Claude.ai/Claude directory form | closeout branch deploy; action-time final-submit approval | host-action |
