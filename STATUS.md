...
|------|-------|---------|--------|
| Claude UI driver send-state guard — fail when prompt remains in composer / send blocked, instead of generic response timeout. | scripts/claude_chat.py, tests/test_claude_chat_send_state.py | - | claimed:codex-gpt5-desktop |
