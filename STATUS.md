...
- [filed:2026-04-30 verified:2026-05-01] Scorched exact reboot loop reported live; AROS path not playable; compat tank-hit green but not accepted.
...
|------|-------|---------|--------|
| Scorched exact-original proof — live Amiga runtime reboots; acceptance requires original path with input, sound, and tank hit. | WebSite/site/static/play/scorched-tanks/, .agents/skills/classic-game-design-test/, .claude/skills/classic-game-design-test/, STATUS.md | - | claimed:codex-gpt5-desktop |
