...
| Exact classic-game browser runtime — PWA remake is insufficient; next path needs lawful original media/assets import or licensed web runtime. | docs/design-notes/2026-04-30-exact-classic-game-browser-runtime.md, live MCP branch 5ef9185bed3f, WebSite/site/static/play/scorched-tanks/ | - | claimed:codex-gpt5-scorched |
