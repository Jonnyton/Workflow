...
| Cross-provider drift invariant gate — wire checker into invariant runner/pre-commit. | STATUS.md, scripts/invariants/cross_provider_drift.py, scripts/invariants_run.py | drift guard landed 4399121 | claimed:codex-gpt5-desktop |
