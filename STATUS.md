...
| Daemon memory quality evals - replay selected entries with/without memory and report outcome deltas. | workflow/daemon_brain.py, scripts/proofs/daemon_memory_quality_eval.py, tests/test_daemon_brain_eval.py, docs/design-notes/2026-05-02-daemon-mini-openbrain.md | daemon memory action surface | claimed:codex-gpt5-desktop ACTIVE 2026-05-02 |
