...
| Worktree status script - ship `scripts/worktree_status.py` referenced by AGENTS and ignore local `_PURPOSE.md`. | .gitignore, scripts/worktree_status.py, tests/test_worktree_status.py, AGENTS.md | worktree coordination spine | claimed:codex-gpt5-desktop ACTIVE 2026-05-02 |
