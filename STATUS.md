...
|------|-------|---------|--------|
| Scorched Tanks autostart ADF — exact-media page now fills tab, but AROS lands at Workbench; patch boot script to launch game. | WebSite/site/static/play/scorched-tanks/ | - | claimed:codex-gpt5-scorched |
