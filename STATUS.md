...
| OpenAI/Claude directory submission host actions - repo closeout landed/deployed in PR #197; OpenAI domain challenge live, Verify Domain pending; Claude UI read proof captured; needs ChatGPT mobile proof, publisher/legal assertions, Claude form submit, final submit. | OpenAI Apps dashboard; ChatGPT mobile app; Claude directory form | action-time Verify Domain/final-submit approval | host-action |
