...
| MCP probe raw exit honesty - raw tool calls must return nonzero on JSON-RPC errors or `isError`. | STATUS.md, scripts/mcp_probe.py | clear | claimed:codex-gpt5-desktop |
