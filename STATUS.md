...
| Emergency DNS workflow canonical canary default - post-apply default must probe `tinyassets.io/mcp`. | STATUS.md, .github/workflows/emergency-dns.yml | clear | claimed:codex-gpt5-desktop |
