...
|------|-------|---------|--------|
| Public MCP P0 recovery — `tinyassets.io/mcp` flaps 502 during prod deploy; verify stable green or fix tunnel deploy path. | STATUS.md, deploy/, .github/workflows/ | production deploy/tunnel | claimed:codex-gpt5-desktop |
