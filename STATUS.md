...
| Exact classic-game browser runtime — PWA remake is insufficient; next path needs lawful original media/assets import or licensed web runtime. | PLAN.md, docs/design-notes/2026-04-30-exact-classic-game-browser-runtime.md, live MCP branch 5ef9185bed3f, WebSite/site/static/play/scorched-tanks/ | - | claimed:codex-gpt5-scorched |
| Community change loop — live proof landed: BUG + promoted non-bug wiki artifacts now sync to `auto-change`; next writer backend + chatbot filing verb. | docs/exec-plans/active/2026-04-30-live-community-reiteration-loop.md, scripts/wiki_bug_sync.py, .github/workflows/{auto-fix-bug,wiki-bug-sync,actionlint}.yml | #18 for runtime/test filing verb; writer auth/bridge | dev-ready |
| Community loop uptime watch — 24/7 acceptance means cloud-visible loop status/alarm; no website UI edit until preview approved. | docs/exec-plans/active/2026-04-30-live-community-reiteration-loop.md, scripts/community_loop_watch.py, .github/workflows/community-loop-watch.yml | website preview approval for UI only | claimed:codex-gpt5-desktop |
