...
|------|-------|---------|--------|
| Arc B prep-plan retirement — move landed Arc B plan out of active and refresh live path wording. | STATUS.md, docs/exec-plans/active/2026-04-26-decomp-arc-b-prep.md, docs/exec-plans/completed/2026-04-26-decomp-arc-b-prep.md | b049f0d | claimed:codex-gpt5-desktop |
