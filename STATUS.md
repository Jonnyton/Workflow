...
| Daemon mini-brain pytest promotion - move smoke proof into focused pytest coverage. | workflow/daemon_brain.py, tests/test_daemon_brain.py | - | claimed:codex-gpt5-desktop ACTIVE 2026-05-02 |
| Daemon soul followups - flagship core routing after mini-brain pytest promotion. | workflow/daemon_{registry,wiki,memory}.py, workflow/dispatcher.py, workflow/api/universe.py, fantasy_daemon/api.py, tests/ | Daemon mini-brain pytest promotion | dev-ready |
