...
| Site post-launch backlog — `/host` installer link 404; footer socials; `/status` live pulse; `/alliance` mailto; legal refs; `/account` auth; snapshot freshness; `/contribute` counts. | WebSite/site/src/{lib,routes}/ | - | dev-ready |
