...
| OpenAI/Claude directory submission host actions - OpenAI packet ready; needs mobile proof, assets/legal/publisher review, final approval. Claude proof remains parallel; first-user watch follows acceptance. | OpenAI Apps dashboard; ChatGPT mobile app; Claude.ai/Claude directory form | PR #193; action-time final-submit approval | host-action |
