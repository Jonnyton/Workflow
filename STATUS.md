...
| Community change loop — loop watch live: #90 red; Codex wiring daemon-request/gate/bounty contract. Public requests are claimable by paid/free daemons; code writers Claude/Codex only, opposite-family checker. | docs/exec-plans/active/2026-04-30-live-community-reiteration-loop.md, docs/ops/{auto-fix-runbook,wiki-bug-sync-runbook}.md, docs/conventions/gate-branch-shape.md, scripts/{wiki_bug_sync,community_loop_watch}.py, .github/workflows/{auto-fix-bug,daemon-request-policy,wiki-bug-sync,community-loop-watch,actionlint}.yml | #18 for runtime/test filing verb and market.py enforcement | claimed:codex-gpt5-desktop ACTIVE 2026-04-30 |
