...
| Community change loop — #90 red; deploy auth sync landed; current slice makes watch dispatch stale wiki/uptime workflows. GHA Claude/Codex subscription secrets false. | .github/workflows/{deploy-prod,community-loop-watch}.yml, deploy/docker-entrypoint.sh, docs/ops/host-independence-runbook.md, docs/exec-plans/active/2026-04-30-live-community-reiteration-loop.md, tests/{test_auto_fix_workflow,test_deploy_prod_workflow,test_dockerfile_shape,test_community_loop_watch_workflow}.py | #18 broad tests lock accepted for uptime unblock | claimed:codex-gpt5-desktop ACTIVE 2026-04-30 |
