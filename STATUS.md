...
| **#24 Arc C** — Phase 1 env-var migration in unblocked entrypoints; resolver/test deletion waits for #18 lock. ACTIVE 2026-05-01 | workflow/storage/__init__.py, fantasy_daemon/__main__.py, packaging/mcpb/server.py, packaging/mcpb/manifest.json, workflow_tray.py, workflow/api/engine_helpers.py | - | claimed:codex-gpt5-desktop |
