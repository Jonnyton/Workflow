...
| **Site shipped 2026-04-29 17:40Z** — add apex `/` 200 coverage to uptime canary + probe catalog; post-launch site backlog remains after this slice. ACTIVE 2026-05-01 | docs/ops/acceptance-probe-catalog.md, scripts/uptime_canary.py | - | claimed:codex-gpt5-desktop |
