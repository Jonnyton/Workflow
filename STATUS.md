...
| Remove obsolete `fantasy_author_original` Ruff exclude — directory already gone; pyproject still skips it. | STATUS.md, pyproject.toml | current import/dir spot-check | claimed:codex-gpt5-desktop |
