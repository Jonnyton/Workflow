...
| Community change loop — Codex subscription live (`llm_endpoint_bound=codex`); adding deploy-complete wakeup to retry stale auth-blocked requests. | .github/workflows/auto-fix-bug.yml, scripts/verify_llm_binding.py, tests/test_{auto_fix_workflow,verify_llm_binding}.py, docs/ops/auto-fix-runbook.md, STATUS.md | - | claimed:codex-gpt5-desktop |
