...
| Desktop reload package drift - remove stale `workflow.judges` allowlist after shim deletion. | workflow/desktop/launcher.py | Navigator shim audit 2026-04-27; `workflow.judges` package already absent | claimed:codex-gpt5-desktop |
