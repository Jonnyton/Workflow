...
| Issue #265 wiki feature smoke bridge — preserve canonical `kind: feature` metadata when feature-request pages carry legacy `type: bug`. | `scripts/wiki_bug_sync.py`, `tests/test_wiki_bug_sync.py`, `_PURPOSE.md`, `.agents/worktrees.md` | Issue #265 | claimed:codex-wiki-feature |
