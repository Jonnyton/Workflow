...
| Issue #582 Jones permission-ladder design note — Claude opposite-family review required before any implementation. | `docs/design-notes/proposed/2026-05-07-anticipation-gap-permission-ladder-jones.md` | WIKI-DOCS #582 | pending |
