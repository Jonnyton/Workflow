...
| Community change loop — #90 red; stale wiki/uptime self-heal live; current slice adds Codex subscription writer lane. GHA Claude/Codex subscription secrets false. | .github/workflows/{auto-fix-bug,deploy-prod,community-loop-watch}.yml, deploy/docker-entrypoint.sh, docs/ops/{auto-fix-runbook,host-independence-runbook}.md, docs/exec-plans/active/2026-04-30-live-community-reiteration-loop.md, scripts/community_loop_watch.py, tests/{test_auto_fix_workflow,test_deploy_prod_workflow,test_dockerfile_shape,test_community_loop_watch_workflow}.py | #18 broad tests lock accepted for uptime unblock | claimed:codex-gpt5-desktop ACTIVE 2026-04-30 |
