...
| Community change loop — #90 red; project-wide default daemon auth now subscription-only; API-key providers require explicit host opt-in. GHA sees `CLAUDE_CODE_OAUTH_TOKEN=false`; writer queue blocked until subscription OAuth is visible. | AGENTS.md, PLAN.md, workflow/{api/status,cloud_worker}.py, workflow/providers/{base,claude_provider,codex_provider,gemini_provider,groq_provider,grok_provider,router}.py, packaging/claude-plugin/plugins/workflow-universe-server/runtime/workflow/{api/status,cloud_worker}.py, packaging/claude-plugin/plugins/workflow-universe-server/runtime/workflow/providers/{base,claude_provider,codex_provider,gemini_provider,groq_provider,grok_provider,router}.py, tests/{test_providers,test_get_status_primitive}.py, docs/exec-plans/active/2026-04-30-live-community-reiteration-loop.md, docs/ops/{auto-fix-runbook,wiki-bug-sync-runbook,host-independence-runbook,host-off-resilience-audit}.md, docs/design-notes/2026-04-21-prod-llm-binding-strategy.md, docs/conventions/gate-branch-shape.md, scripts/{wiki_bug_sync,community_loop_watch,verify_llm_binding}.py, .github/workflows/{auto-fix-bug,daemon-request-policy,wiki-bug-sync,community-loop-watch,actionlint,llm-binding-canary}.yml, deploy/docker-entrypoint.sh, deploy/workflow-env.template, deploy/compose.yml, Dockerfile | #18 for test filing verb and market.py enforcement | claimed:codex-gpt5-desktop ACTIVE 2026-04-30 |
