...
| **Phase 6** (nav 2026-04-28): `.workflow.db`, `db_path()` fn, Option A migration, 30s restart, plugin minor-bump. ~2-3h dev + 1h host. | workflow/storage/__init__.py, workflow/daemon_server.py, workflow/api/branches.py, workflow/payments/escrow.py, packaging/claude-plugin/plugins/workflow-universe-server/runtime/workflow/storage/__init__.py, packaging/claude-plugin/plugins/workflow-universe-server/runtime/workflow/daemon_server.py, packaging/claude-plugin/plugins/workflow-universe-server/runtime/workflow/api/branches.py, packaging/claude-plugin/plugins/workflow-universe-server/runtime/workflow/payments/escrow.py, tests/ | - | claimed:codex-gpt5-desktop ACTIVE 2026-05-02 |
