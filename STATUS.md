...
| Community change loop — #90 red; auto-fix + cloud deploy now subscription-only. GHA sees `CLAUDE_CODE_OAUTH_TOKEN=false`; writer queue blocked until subscription OAuth is visible. | docs/exec-plans/active/2026-04-30-live-community-reiteration-loop.md, docs/ops/{auto-fix-runbook,wiki-bug-sync-runbook,host-independence-runbook,host-off-resilience-audit}.md, docs/design-notes/2026-04-21-prod-llm-binding-strategy.md, docs/conventions/gate-branch-shape.md, scripts/{wiki_bug_sync,community_loop_watch,verify_llm_binding}.py, .github/workflows/{auto-fix-bug,daemon-request-policy,wiki-bug-sync,community-loop-watch,actionlint,llm-binding-canary}.yml, deploy/docker-entrypoint.sh, deploy/workflow-env.template, deploy/compose.yml, Dockerfile | #18 for runtime/test filing verb and market.py enforcement | claimed:codex-gpt5-desktop ACTIVE 2026-04-30 |
