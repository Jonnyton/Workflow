...
| Community change loop — Codex subscription live; auto-fix woke and hit GHA bwrap sandbox failure; patching Codex no-internal-sandbox lane. | .github/workflows/auto-fix-bug.yml, scripts/verify_llm_binding.py, tests/test_{auto_fix_workflow,verify_llm_binding}.py, docs/ops/auto-fix-runbook.md, STATUS.md | - | claimed:codex-gpt5-desktop |
