...
| OpenAI/Claude directory submission host actions - repo closeout landed/deployed in PR #197; needs ChatGPT mobile proof, publisher/legal assertions, final submit; Claude UI proof/form submit. | OpenAI Apps dashboard; ChatGPT mobile app; Claude.ai/Claude directory form | action-time final-submit approval | host-action |
