...
| Directory submissions/onboarding readiness - ChatGPT web proof green; OpenAI blockers are mobile proof, assets/legal/publisher review, final approval. Claude proof is parallel; first-user clean-use becomes post-submit monitoring. | chatgpt-app-submission.json, docs/ops/openai-app-submission-*.md, docs/ops/mcp-host-proof-registry.md | action-time compliance/final-submit approval | claimed:codex-gpt5-desktop-openai-submission |
