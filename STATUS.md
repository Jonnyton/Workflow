...
| Live community change loop — ACTIVE 2026-04-30: all project evolution, not bug-only; BUG-044 -> GH #89 -> auto-fix -> `needs-human`; no Claude auth. | docs/exec-plans/active/2026-04-30-live-community-reiteration-loop.md, scripts/wiki_bug_sync.py, .github/workflows/{auto-fix-bug,actionlint}.yml, .agents/.wiki_bug_sync_cursor, .agents/uptime.log | #18 for test edits | claimed:codex-gpt5-desktop |
