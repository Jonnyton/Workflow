...
| Skill validation invariant gate — wire validate_skills.py into invariant runner/pre-commit. | STATUS.md, scripts/invariants/skills_valid.py, scripts/invariants_run.py | validate_skills green | claimed:codex-gpt5-desktop |
