...
| Project-instruction cross-check refresh — AGENTS already carries no-destructive-git, mirror rebuild, and audit-decay rules. | STATUS.md, docs/audits/2026-04-28-project-instruction-files-cross-check.md | current AGENTS spot-check | claimed:codex-gpt5-desktop |
