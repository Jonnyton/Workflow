...
| Fold Codex provider env-var docs from forgotten `../wf-agents-envvars` lane; close if current deploy files still match. | AGENTS.md | no overlap via `claim_check --check-files AGENTS.md` | claimed:codex-gpt5-desktop |
