...
| Directory submissions + first-use evidence - OpenAI app draft at Submit; `/mcp-directory` scan green; web read tests green; TC2 no-match copy saved. Final blocked on release notes, submit-page legal fields, write-path/mobile tests, and submit approval. | chatgpt-app-submission.json, docs/ops/mcp-*.md, docs/ops/openai-app-submission-prep-2026-05-02.md | action-time compliance/final-submit approval | host-action |
| Community change loop - watch/canary green 2026-05-02 05:05Z; P1a attach receipt live via PR #136; goal_pool->branch run green; next: BUG-045 invoke authoring + incentive-directed pickup. | docs/exec-plans/active/2026-04-30-live-community-reiteration-loop.md, docs/ops/auto-fix-runbook.md | API/tests claim | monitoring |
| Live invoke child provider propagation - public parent now spawns child, but child prompt nodes used mock because provider_call is not threaded. | workflow/graph_compiler.py, packaging/claude-plugin/plugins/workflow-universe-server/runtime/workflow/graph_compiler.py | #148 deployed | claimed:codex-loop-uptime ACTIVE 2026-05-02 |
| Daemon mini-brain MCP actions - expose capture/search/list/status/review/promote through `universe`. | workflow/api/universe.py, workflow/daemon_brain.py, tests/test_daemon_brain_api.py, tests/test_api_universe.py, tests/test_mcp_dispatch_docstring_parity.py, packaging/claude-plugin/plugins/workflow-universe-server/runtime/workflow/api/universe.py, packaging/claude-plugin/plugins/workflow-universe-server/runtime/workflow/daemon_brain.py | - | claimed:codex-gpt5-desktop ACTIVE 2026-05-02 |
| Daemon soul followups - flagship core routing after mini-brain MCP actions. | workflow/daemon_{registry,wiki,memory}.py, workflow/dispatcher.py, workflow/api/universe.py, fantasy_daemon/api.py, tests/ | Daemon mini-brain MCP actions | dev-ready |
