...
| Community change loop — Codex subscription live; syncing prod compose so cloud worker actually runs and drains requests. | .github/workflows/auto-fix-bug.yml, .github/workflows/deploy-prod.yml, tests/test_{auto_fix_workflow,deploy_prod_workflow,verify_llm_binding}.py, docs/ops/auto-fix-runbook.md, STATUS.md | - | claimed:codex-gpt5-desktop |
