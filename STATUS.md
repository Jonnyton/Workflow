...
| DOME KG feedback annotations - turn planning KG feedback into deterministic beat notes instead of nominal enrichment. | workflow/planning/dome_expansion.py | code TODO; no overlap with loop/wiki/MCP rows | claimed:codex-gpt5-desktop |
