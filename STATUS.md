...
| Science-domain catalog seed — park `hyperparameter_importance` as domain catalog work, not engine work. | docs/catalogs/scientific-computing-domain-catalog.md, ideas/PIPELINE.md | - | claimed:codex-gpt5-desktop |
