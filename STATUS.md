...
| `run_branch resume_from=<run_id>` param (F2 ACCEPTED 2026-04-28). Single param add. | workflow/universe_server.py, workflow/api/{extensions,runs}.py, packaging/claude-plugin/plugins/workflow-universe-server/runtime/workflow/{universe_server.py,api/{extensions,runs}.py}, tests/ | - | claimed:codex-gpt5-desktop |
