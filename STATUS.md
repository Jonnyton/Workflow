...
| Community change loop — Codex subscription live; patching hosted no-change outcomes so old `needs-human` requests close or park cleanly. | .github/workflows/auto-fix-bug.yml, scripts/verify_llm_binding.py, tests/test_{auto_fix_workflow,verify_llm_binding}.py, docs/ops/auto-fix-runbook.md, STATUS.md | - | claimed:codex-gpt5-desktop |
