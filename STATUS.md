...
| **Phase 6** (nav 2026-04-28): `.workflow.db`, `db_path()` fn, Option A migration, 30s restart, plugin minor-bump. ~2-3h dev + 1h host. | workflow/storage/__init__.py, workflow/daemon_server.py, workflow/api/branches.py, workflow/payments/escrow.py, workflow/__init__.py, packaging/claude-plugin/plugins/workflow-universe-server/.claude-plugin/plugin.json, packaging/claude-plugin/plugins/workflow-universe-server/runtime/pyproject.toml, packaging/claude-plugin/plugins/workflow-universe-server/runtime/server.py, packaging/claude-plugin/plugins/workflow-universe-server/runtime/workflow/storage/__init__.py, packaging/claude-plugin/plugins/workflow-universe-server/runtime/workflow/daemon_server.py, packaging/claude-plugin/plugins/workflow-universe-server/runtime/workflow/api/branches.py, packaging/claude-plugin/plugins/workflow-universe-server/runtime/workflow/payments/escrow.py, packaging/claude-plugin/plugins/workflow-universe-server/runtime/workflow/__init__.py, deploy/RESTORE.md, tests/ | - | claimed:codex-gpt5-desktop ACTIVE 2026-05-02 |
...
| Goal-pool prod pickup flip - enable restart-time pool producer/shared pool path, then prove live pickup. | deploy/compose.yml, deploy/workflow-env.template, workflow/producers/goal_pool.py, packaging/claude-plugin/plugins/workflow-universe-server/runtime/workflow/producers/goal_pool.py | Community loop proof 2026-05-02 | claimed:codex-loop-uptime |
