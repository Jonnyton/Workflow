...
| Concerns resolver filed-date parser — current STATUS concern metadata is invisible to concerns-staleness. | STATUS.md, scripts/concerns_resolve.py | clear | claimed:codex-gpt5-desktop |
