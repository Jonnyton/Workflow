...
| MCP probe args hardening - accept PowerShell-stripped simple `{action:...}` raw args and document the fallback. | scripts/mcp_probe.py, tests/test_mcp_probe.py, docs/ops/workflow-probe-reference.md | live probe args failure 2026-05-02 | claimed:codex-gpt5-desktop |
