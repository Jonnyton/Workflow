...
| Community change loop — loop watch live: #90 red (writer backlog + P0 #79); next writer backend/queue drain + chatbot filing verb. | docs/exec-plans/active/2026-04-30-live-community-reiteration-loop.md, scripts/{wiki_bug_sync,community_loop_watch}.py, .github/workflows/{auto-fix-bug,wiki-bug-sync,community-loop-watch,actionlint}.yml | #18 for runtime/test filing verb; writer auth/bridge | dev-ready |
