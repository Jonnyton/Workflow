...
| Live community reiteration loop execution pack — ACTIVE 2026-04-30: wire wiki bugs -> user/community branches -> fix PRs -> live observation tests; no branch redesign. | docs/exec-plans/active/2026-04-30-live-community-reiteration-loop.md | - | claimed:codex-gpt5-desktop |
