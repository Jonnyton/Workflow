...
| External directory acceptance — MCP Registry + Claude/ChatGPT directory submissions; Open WebUI Docker proof green; needs next no-login proof + first-user evidence. | packaging/registry/server.json, chatgpt-app-submission.json, docs/ops/mcp-*.md, docs/exec-plans/active/2026-05-01-host-discoverability-and-onboarding-rollout.md | host/admin publisher | host-action |
