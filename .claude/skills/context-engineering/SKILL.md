...
For this repo, `AGENTS.md` owns process truth. `CLAUDE.md` and `CODEX.md`
should stay thin routing layers unless the project explicitly changes that.

**AGENTS.md** (project-wide process truth):
```markdown
# Project: [Name]
...
**Equivalent or routing files for other tools:**
