...
- **Stub pages** (`/status`, `/account`): keep them honest about Phase 1.5 / Phase 2 status. Don't fake content. `/goals` is the canonical Goals lens; `/catalog` is only a compatibility redirect.
