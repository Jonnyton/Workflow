...
Compatibility finding, verified 2026-05-01: Scorched Tanks v1.90 now autostarts with a valid Startup-Sequence header and reaches the AMOS executable under AROS in vAmigaWeb. Exact-game acceptance remains `NEEDS_RIGHTS_CLEARED_FIRMWARE` until a deployment supplies the hosted Kickstart path above and verifies successful play.
