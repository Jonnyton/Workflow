...
<script lang="ts">
  ...
  const beats = [
    ...
    { n: '05', label: 'Loop evolves',  blurb: "The same public record can tune goals, gates, branches, and routing. The substrate changes through visible evidence, not hidden planning." }
  ];
</script>
