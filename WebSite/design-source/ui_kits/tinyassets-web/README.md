# TinyAssets Web — UI Kit

A pixel-faithful recreation of the TinyAssets marketing + connect + catalog + host surfaces, as a React/JSX click-through prototype.

## Source

- `TinyAssets/prototype/web-app-v0/` — SvelteKit prototype (routes: `/`, `/connect`, `/catalog`, `/host`, `/account`, `/contribute`, `/legal`, `/status`).
