// Economy.jsx — the tinyassets.io reframe. Rebrands the old token into the economic layer of TinyAssets.
...
function Economy() {
  ...
  return (
    <div style={{ maxWidth: 1240, margin: "0 auto", padding: "72px 32px" }}>
      <RitualLabel color="var(--ember-500)">· tinyassets.io → TinyAssets economy · in development ·</RitualLabel>
      ...
      <p style={{ fontSize: 14, color: "var(--fg-3)", maxWidth: 760, fontStyle: "italic", margin: "0 0 40px" }}>
        Refactor of the original tinyassets token. Same ticker (ta), same holders, new substrate: TinyAssets.
      </p>
