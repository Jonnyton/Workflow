...
function DesktopDownload({ os, setOs }) {
  const builds = {
    macos:   { file: "TinyAssets-0.4.2-arm64.dmg",       size: "42.1 MB", cmd: "brew install workflow-host" },
    windows: { file: "TinyAssets-Host-0.4.2-Setup.exe", size: "38.7 MB", cmd: "winget install Jonnyton.TinyAssetsHost" },
