...
const DIAGRAMS = [
  ...
  },
  {
    ...
    callout: { label: "Read it once from the top", body: "Every team you'll ever build on TinyAssets is a composition of these seven rules. Chat with your chatbot, redesign the team, the rules don't change." },
    accent: "var(--ember-600)",
  },
];
