...
- **OAuth 2.1 + PKCE** at the MCP edge for tier-1 chatbot users connecting via Claude.ai (`tinyassets.io/mcp` — canonical apex URL, Worker-routed to tunnel origin at `mcp.tinyassets.io`).
