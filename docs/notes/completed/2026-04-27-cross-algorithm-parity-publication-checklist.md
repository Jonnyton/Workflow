...
> **Superseded 2026-04-28** by wiki page `pages/concepts/cross-algorithm-parity-rf-vs-maxent.md` (publication checklist's pre-publish + evidence + verification steps applied during promote; seed instance live). Retained as drafting record.
