...
| ChatGPT App Directory | app draft; submit blocked | `chatgpt-app-submission.json` covers the 11 directory tools with 10 positive and 4 negative tests; 2026-05-02 dashboard draft uses `/mcp-directory`; PR #184 strict redaction deploy/proof and ChatGPT web read/write proof are green; legal/connect closeout landed; OpenAI domain is verified; final submit remains blocked on mobile proof, legal/publisher assertions, and action-time host approval |
