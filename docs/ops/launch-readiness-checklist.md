...
- [ ] **OAuth 2.1 + PKCE flow works end-to-end** from a real browser chatbot client with the TinyAssets connector installed (Claude.ai, ChatGPT Developer Mode, or equivalent; per spec #27 §5.1).
