...
Future agents should update project manifests and portfolio docs when project status, lineage, public visibility, or repo structure changes. Public publishing remains gated by scanning and review.
