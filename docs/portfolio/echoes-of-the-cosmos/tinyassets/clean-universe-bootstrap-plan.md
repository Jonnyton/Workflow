# Clean TinyAssets Universe Bootstrap Plan

Goal: create a fresh Echoes of the Cosmos universe in TinyAssets instead of attaching the public project to an old test universe.
...
The initial TinyAssets universe should contain:
...
- TinyAssets can answer basic canon queries from those docs
...
- Should TinyAssets store the public canon docs directly, or mirror them from the Echoes repo?
