...
from fantasy_author.learning.craft_cards import generate_craft_cards
from fantasy_author.learning.criteria_discovery import discover_criteria
from fantasy_author.learning.style_rules import LearningSystem, Observation
