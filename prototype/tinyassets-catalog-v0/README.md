# TinyAssets-catalog/ v0 — Repo Skeleton

**Status:** Skeleton of the content-repo that will eventually live at a separate GitHub repo (`<org>/TinyAssets-catalog/`) per spec #32 §1.2. For this prototype, it lives as a subdirectory of the main repo.
...
```
prototype/tinyassets-catalog-v0/
├── README.md              # this file
...
- Bot identity placeholder (`tinyassets-catalog-bot[bot]` doesn't exist yet).
