...
class LauncherApp:
    ...
    _RELOAD_PACKAGES = (
        "fantasy_author.nodes",
        "fantasy_author.providers",
        "fantasy_author.evaluation",
        "fantasy_author.judges",
        "fantasy_author.constraints",
        "fantasy_author.planning",
        "fantasy_author.knowledge",
        "fantasy_author.retrieval",
        "fantasy_author.memory",
        "fantasy_author.graphs",
        "fantasy_author.checkpointing",
        "fantasy_author.state",
        "fantasy_author.learning",
    )
    ...
    def _classify_changes(self) -> str:
        ...
        ui_paths = ("fantasy_author/desktop/launcher.py", "fantasy_author/desktop/tray.py")
