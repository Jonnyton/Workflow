...
from fantasy_author.evaluation.editorial import EditorialNotes, read_editorial
from fantasy_author.evaluation.process import ProcessEvaluation, evaluate_scene_process
from fantasy_author.evaluation.structural import StructuralEvaluator, StructuralResult
from fantasy_author.nodes._provider_stub import call_for_extraction, call_provider
...
def commit(state: dict[str, Any]) -> dict[str, Any]:
    ...
    from fantasy_author.nodes._paths import resolve_db_path
...
def _store_editorial_as_notes(
    ...
    try:
        ...
        from fantasy_author.notes import Note, add_notes_bulk
...
def _store_consistency_audit_as_notes(
    ...
    try:
        from fantasy_author.notes import add_notes_bulk
...
def _build_consistency_audit_notes(
    ...
    from fantasy_author.notes import Note
...
def _emit_scene_packet(
    ...
    """
    from fantasy_author.packets import (
        EditorialVerdict,
        FactRef,
        PromiseRef,
        ScenePacket,
