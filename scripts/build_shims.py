...
def build_shims():
    ...
    print("Backed up fantasy_author/ -> fantasy_author_original/")
    ...
    count += 1
    print("  fantasy_author/__main__.py -> delegate to workflow.__main__")
    ...
    print("  fantasy_author/__init__.py -> deprecation notice")

    print(f"\nConverted {count} files to shims.")
    print("Original code backed up in fantasy_author_original/")
